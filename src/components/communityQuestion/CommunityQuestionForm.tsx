...
const CommunityQuestionForm = () => {
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col px-[25px]">
      <div className="flex items-start pb-[16px]">
        <span className="mt-[17.6px] pr-[39px] text-[16px] font-semibold">
          제목
        </span>
        <input
          className="min-h-[64px] w-[312px] max-w-[312px] rounded-lg border border-[#d9d9d9] pl-[12px]"
          type="text"
      ...
      <div className="flex items-start ">
        ...
        <textarea
          ...
          className="min-h-[282px] w-[312px] max-w-[312px]  resize-none rounded-lg border border-[#d9d9d9] px-[12px] pt-[12px]"
        />
      </div>
      <div className="relative flex items-start gap-[12px] pt-[16px]">
        ...
        <input
          ...
          style={{ display: 'none' }}
        />
        <div className="scroll-hidden mt-[-5px] flex items-center gap-[12px] overflow-x-scroll pr-[8px] pt-[5px]">
      ...
      <button className="mt-[32px] flex h-[64px] w-[382px] cursor-pointer items-center justify-center rounded-lg bg-[#3ddacb] px-[133px] py-[20px]">
